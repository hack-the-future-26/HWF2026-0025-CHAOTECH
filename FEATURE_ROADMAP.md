...
| 9 | **Fresher or live government data**: JJM water testing, CWC river levels, SACHET alerts loaded; wired into evidence 2026-09-15 | ✅ Loaded (Tasks 1-3, commits 4b880f2/ea4cd95/aac9de9) + wired as evidence-only corroboration (see below); UDISE+ loader has **stopped, not still running** — 7,450/9,352 (79.6%) as of 2026-09-14 21:23, checked live 2026-09-15 (no process running); needs a manual re-run of `backend/load_udise_school_data.py` to finish the remaining ~1,900; eMARG blocked by CAPTCHA; **JJM scheme money (Task 4) was never attempted** — no commit, no table, not reported either way | `BUILD_PROMPT_DATA_PIPELINES_REMAINING.md` |
...
| 14 | **PRIASoft village-panchayat receipt & expenditure** (real ₹ in/out per village, tied/untied 15th Finance Commission grant, no CAPTCHA) | ✅ Loaded (040b3b0), verified live and against the db 2026-09-15: 4,826 rows, Kolhapur matched 1,366/2,050 (66.6%), Nashik 651/2,776 (23.5% — genuine, Nashik's own gazetteer only has 289 villages vs 1,298 PRIASoft names there, not a bug). **The strongest investment data on the project so far** — real per-village money, unlike the district-only GPDP summary. Not yet wired into `intelligence/investment.py` | `BUILD_PROMPT_PRIASOFT_RECEIPT_EXPENDITURE.md` |
